...
class TestRunIntegration:
    ...
    def _make_provenance(self) -> dict:
        return {
            ...
            "Q002": {
                "category": "strength",
                "papers": [
                    {"raw_id": "PMID:3", "resolved_pmid": "3", "indexed": True,
                     "failure_reason": None, "resolved_doi": "10.1/c"},
                ],
            },
    ...
    def _make_seed(self) -> list[dict]:
        return [
            {"id": "Q001", "query": "vol query", "query_ko": "볼륨",
             "category": "hypertrophy", "fitness_goals": ["hypertrophy"],
             "used_in": ["routine_generation"], "expected_pmids": [], "notes": ""},
            {"id": "Q002", "query": "strength query", "query_ko": "강도",
             "category": "strength", "fitness_goals": ["strength"],
             "used_in": ["routine_generation"], "expected_pmids": [], "notes": ""},
            {"id": "Q003", "query": "rest query", "query_ko": "휴식",
             "category": "hypertrophy", "fitness_goals": ["hypertrophy"],
             "used_in": ["routine_generation"], "expected_pmids": [], "notes": ""},
        ]
    ...
    def test_run_creates_goldset_jsonl(self, tmp_path):
        ...
        entries = [json.loads(l) for l in goldset_path.read_text().strip().splitlines()]
    ...
    def test_run_corpus_gap_vs_unlabeled(self, tmp_path):
        ...
        seed = [
            {"id": "Q001", "query": "vol", "query_ko": "볼",
             "category": "hypertrophy", "fitness_goals": ["hypertrophy"],
             "used_in": ["routine_generation"], "expected_pmids": [], "notes": ""},
            {"id": "Q002", "query": "rest", "query_ko": "휴",
             "category": "hypertrophy", "fitness_goals": ["hypertrophy"],
             "used_in": ["routine_generation"], "expected_pmids": [], "notes": ""},
        ]
        prov_path = tmp_path / "provenance.json"
    ...
    def test_run_expected_pmids_field(self, tmp_path):
        ...
        provenance = {
            "Q001": {
                "category": "hypertrophy",
                "papers": [
                    {"raw_id": "PMID:10", "resolved_pmid": "10", "indexed": True,
                     "failure_reason": None, "resolved_doi": "10.1/x"},
                    {"raw_id": "PMID:20", "resolved_pmid": "20", "indexed": True,
                     "failure_reason": None, "resolved_doi": "10.1/y"},
                    {"raw_id": "PMID:30", "resolved_pmid": "30", "indexed": False,
                     "failure_reason": "no_fulltext", "resolved_doi": "10.1/z"},
                ],
            },
        }
        seed = [{"id": "Q001", "query": "x", "query_ko": "x",
                 "category": "hypertrophy", "fitness_goals": ["hypertrophy"],
                 "used_in": ["routine_generation"], "expected_pmids": [], "notes": ""}]
        prov_path = tmp_path / "provenance.json"
        prov_path.write_text(json.dumps(provenance), encoding="utf-8")
