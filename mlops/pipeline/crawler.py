...
#
# concept_ids 가이드:
#   "C2779017737" = Resistance training (OpenAlex Concept)
#   영양/수면/심리/스포츠과학 일반 등은 concept ID 부재 또는 부적합으로 빈 리스트.
#
# keywords는 OpenAlex `search` 파라미터에 join되어 텍스트 검색으로 사용된다.
# 카테고리명을 그대로 빈 매핑으로 둘 수도 있지만, baseline 회수율을 위해 65개 모두
# 명시적으로 채워두었다.
CATEGORY_OPENALEX_MAPPING: dict[str, dict] = {
    "volume":                {"concept_ids": ["C2779017737"], "keywords": ["training volume", "volume load", "weekly sets", "sets per muscle"]},
    "intensity":             {"concept_ids": ["C2779017737"], "keywords": ["training intensity", "%1RM", "high load", "low load"]},
    "frequency":             {"concept_ids": ["C2779017737"], "keywords": ["training frequency", "weekly frequency", "sessions per week"]},
    "hypertrophy_strength":  {"concept_ids": ["C2779017737"], "keywords": ["muscle hypertrophy", "muscle strength", "1RM"]},
    "trained_status":        {"concept_ids": ["C2779017737"], "keywords": ["trained individuals", "untrained", "novice", "beginners"]},
    "rest_interval":         {"concept_ids": ["C2779017737"], "keywords": ["rest interval", "inter-set rest"]},
    "failure_rir":           {"concept_ids": ["C2779017737"], "keywords": ["training to failure", "repetitions in reserve", "RIR"]},
    "exercise_order":        {"concept_ids": ["C2779017737"], "keywords": ["exercise order", "exercise sequence"]},
    "recommendation_system": {"concept_ids": [],                "keywords": ["exercise recommendation system", "fitness recommendation", "workout recommendation"]},
    "personalized_prescription": {"concept_ids": [],            "keywords": ["personalized exercise prescription", "individualized exercise program"]},
    "machine_vs_freeweight": {"concept_ids": ["C2779017737"], "keywords": ["machine", "free weight", "selectorized", "plate loaded"]},
    "emg_activation":        {"concept_ids": ["C2779017737"], "keywords": ["electromyography", "EMG", "muscle activation"]},
    "periodization":         {"concept_ids": ["C2779017737"], "keywords": ["periodization", "linear periodization", "undulating", "block"]},
    "deload_recovery":       {"concept_ids": ["C2779017737"], "keywords": ["deload", "recovery week", "tapering"]},
    "doms_recovery":         {"concept_ids": ["C2779017737"], "keywords": ["delayed onset muscle soreness", "DOMS", "muscle damage"]},
    "older_adults":          {"concept_ids": ["C2779017737"], "keywords": ["older adults", "elderly", "sarcopenia", "aging"]},
    "women_resistance":      {"concept_ids": ["C2779017737"], "keywords": ["women", "female", "menstrual cycle"]},
    "injury_prevention":     {"concept_ids": ["C2779017737"], "keywords": ["injury prevention", "lower back pain", "rotator cuff"]},
    "range_of_motion":       {"concept_ids": ["C2779017737"], "keywords": ["range of motion", "ROM", "full range", "partial range"]},
    "tempo_tut":             {"concept_ids": ["C2779017737"], "keywords": ["tempo", "time under tension", "lifting cadence", "movement velocity"]},
    "contraction_mode":      {"concept_ids": ["C2779017737"], "keywords": ["eccentric", "concentric", "isometric"]},
    "compound_isolation":    {"concept_ids": ["C2779017737"], "keywords": ["compound exercise", "multi-joint", "single-joint", "isolation exercise"]},
    "chest_training":        {"concept_ids": ["C2779017737"], "keywords": ["bench press", "pectoral", "chest", "pectoralis"]},
    "back_training":         {"concept_ids": ["C2779017737"], "keywords": ["row", "pull-down", "latissimus", "pull-up"]},
    "legs_training":         {"concept_ids": ["C2779017737"], "keywords": ["squat", "deadlift", "leg press", "quadriceps", "hamstring"]},
    "shoulders_training":    {"concept_ids": ["C2779017737"], "keywords": ["shoulder press", "overhead press", "deltoid", "lateral raise"]},
    "arms_training":         {"concept_ids": ["C2779017737"], "keywords": ["biceps curl", "triceps extension", "elbow flexion"]},
    "core_training":         {"concept_ids": ["C2779017737"], "keywords": ["abdominal", "trunk stability", "core stability", "rectus abdominis"]},
    "load_progression":      {"concept_ids": ["C2779017737"], "keywords": ["progressive overload", "load progression", "training progression"]},
    "muscular_endurance":    {"concept_ids": ["C2779017737"], "keywords": ["muscular endurance", "endurance training"]},
    "concurrent_training":   {"concept_ids": ["C2779017737"], "keywords": ["concurrent training", "endurance and strength"]},
    ...
    "exercise_variation":    {"concept_ids": ["C2779017737"], "keywords": ["exercise variation", "exercise selection"]},
    "blood_flow_restriction": {"concept_ids": ["C2779017737"], "keywords": ["blood flow restriction", "BFR training", "occlusion training"]},
    "explosive_power_speed": {"concept_ids": ["C2779017737"], "keywords": ["explosive power", "power training", "speed strength"]},
    "instability_training":  {"concept_ids": ["C2779017737"], "keywords": ["instability training", "unstable surface", "balance training"]},
    "plyometric_training":   {"concept_ids": [],                "keywords": ["plyometric training", "jump training", "stretch-shortening cycle"]},
    "detraining":            {"concept_ids": ["C2779017737"], "keywords": ["detraining", "training cessation", "loss of strength"]},
    ...
    "unilateral_training":   {"concept_ids": ["C2779017737"], "keywords": ["unilateral training", "single leg", "single arm"]},
    "resistance_band":       {"concept_ids": ["C2779017737"], "keywords": ["resistance band", "elastic resistance"]},
    "circuit_training":      {"concept_ids": ["C2779017737"], "keywords": ["circuit training"]},
    ...
    "velocity_based_training": {"concept_ids": ["C2779017737"], "keywords": ["velocity based training", "VBT", "bar velocity"]},
    "rpe_perceived_exertion": {"concept_ids": ["C2779017737"], "keywords": ["rate of perceived exertion", "RPE"]},
    ...
    "training_split":        {"concept_ids": ["C2779017737"], "keywords": ["training split", "push pull legs", "upper lower split"]},
    "advanced_techniques":   {"concept_ids": ["C2779017737"], "keywords": ["drop set", "supersets", "advanced training techniques"]},
    "bodyweight_training":   {"concept_ids": ["C2779017737"], "keywords": ["bodyweight training", "calisthenics"]},
    "mechanical_tension":    {"concept_ids": ["C2779017737"], "keywords": ["mechanical tension", "muscle tension"]},
    "individual_response":   {"concept_ids": ["C2779017737"], "keywords": ["individual response", "responders", "non-responders"]},
    "olympic_lifting":       {"concept_ids": ["C2779017737"], "keywords": ["olympic lifting", "clean and jerk", "snatch"]},
    ...
    "minimum_effective_dose": {"concept_ids": ["C2779017737"], "keywords": ["minimum effective dose", "minimal effective volume"]},
    "stretching_flexibility": {"concept_ids": ["C2779017737"], "keywords": ["stretching", "flexibility", "static stretching"]},
    "cross_education":       {"concept_ids": ["C2779017737"], "keywords": ["cross education", "contralateral training effect"]},
    "muscle_fiber_type":     {"concept_ids": ["C2779017737"], "keywords": ["muscle fiber type", "type I", "type II", "fast twitch"]},
    "neuromuscular_adaptation": {"concept_ids": ["C2779017737"], "keywords": ["neuromuscular adaptation", "neural drive"]},
}
...
def crawl_papers(
    *,
    ...
    logger.info(
        ...
        len(papers), indexed_count, len(papers) - indexed_count,
    )
    return papers
