...
CATEGORY_OPENALEX_MAPPING: dict[str, dict] = {
    ...
    "machine_vs_freeweight": {"concept_ids": [], "keywords": ["machine", "free weight", "selectorized", "plate loaded"]},
    ...
    "tempo_tut":             {"concept_ids": [], "keywords": ["tempo", "time under tension", "lifting cadence", "movement velocity"]},
    "contraction_mode":      {"concept_ids": [], "keywords": ["eccentric", "concentric", "isometric"]},
    "compound_isolation":    {"concept_ids": [], "keywords": ["compound exercise", "multi-joint", "single-joint", "isolation exercise"]},
    ...
    "shoulders_training":    {"concept_ids": [], "keywords": ["shoulder press", "overhead press", "deltoid", "lateral raise"]},
    "arms_training":         {"concept_ids": [], "keywords": ["biceps curl", "triceps extension", "elbow flexion"]},
    "core_training":         {"concept_ids": [], "keywords": ["abdominal", "trunk stability", "core stability", "rectus abdominis"]},
    "load_progression":      {"concept_ids": [], "keywords": ["progressive overload", "load progression", "training progression"]},
    ...
    "blood_flow_restriction": {"concept_ids": [], "keywords": ["blood flow restriction", "BFR training", "occlusion training"]},
    "explosive_power_speed": {"concept_ids": [], "keywords": ["explosive power", "power training", "speed strength"]},
    "instability_training":  {"concept_ids": [], "keywords": ["instability training", "unstable surface", "balance training"]},
