...
export default function WP02EditBodyInfo() {
  ...
  const [birth_date, set_birth_date] = useState("2000년 1월 1일");
  const [height, set_height] = useState("175");
  const [weight, set_weight] = useState("75");
          ...
          <View style={styles.card}>
            ...
            <View style={styles.field}>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.8}
              >
                <Text style={styles.input_text}>{birth_date}</Text>
              </TouchableOpacity>
            </View>
