...
A. `batch_size=200`은 ALB 300초 한도 안전. 실패 시 batch_size를 100으로 더 줄임 + 502/503/504 retry는 이미 코드에 내장.
...
- 관련 PR: #179 (PR-α efetch), #181 (PR-β JATS), #182 (PR-δ+ε alias-swap), #184 (PR-γ orchestrator)
